    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-indigo-600 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
        <div class="p-8 sm:p-10 lg:flex-auto">
          <h1 class="text-2xl font-bold tracking-tight text-indigo-700">KASUAL</h1>
          <p class="mt-6 text-base leading-7 text-gray-600">Paket Tipe 1</p>
          ...
          <div class="rounded-2xl bg-indigo-100 py-10 text-center ring-1 ring-inset ring-indigo-100 lg:flex lg:flex-col lg:justify-center lg:py-16">
            <div class="mx-auto max-w-xs px-8">
              ...
              <p class="mt-6 flex items-baseline justify-center gap-x-2">
                <span class="text-5xl font-bold tracking-tight text-gray-900">  Rp.50.000</span>
...
<div class="main-modal fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster"
    ...
    <div
        ...
        <div class="modal-content py-4 text-left px-6">
            ...
            <!--Body-->
            <div class="my-5">
                <p>Selamat, anda kini berlangganan Paket Tipe 1: Kasual. Klik selanjutnya untuk halaman selanjutnya.</p>
            </div>
            <!--Footer-->
